	...
	: Super(PCIP)
{
	...
	static ConstructorHelpers::FObjectFinder<USoundCue> sound(TEXT("SoundCue'/Game/Audio/Monstres/Extender/attack-extender_Cue.attack-extender_Cue'"));
	if (sound.Object)
		AtkSound = sound.Object;
	static ConstructorHelpers::FObjectFinder<USoundCue> sound2(TEXT("SoundCue'/Game/Audio/Monstres/Extender/dead-extender_Cue.dead-extender_Cue'"));
	if (sound2.Object)
